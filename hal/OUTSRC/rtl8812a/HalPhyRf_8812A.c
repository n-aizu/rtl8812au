	...
	)
{
	...
	ODM_Write4Byte(pDM_Odm, 0xe90, 0x00000080);
	ODM_Write4Byte(pDM_Odm, 0xe94, 0x00000000);
	ODM_Write4Byte(pDM_Odm, 0xec4, 0x20040000);
	ODM_Write4Byte(pDM_Odm, 0xec8, 0x20000000);
	...
	)
{
	...
	int			TX_IQC_temp[3][4], TX_IQC[4]={};		//TX_IQC = [TX0_X, TX0_Y,TX1_X,TX1_Y]; for 3 times
	int			RX_IQC_temp[3][4], RX_IQC[4]={};		//RX_IQC = [RX0_X, RX0_Y,RX1_X,RX1_Y]; for 3 times
	...
	if (VDF_enable == 1){}
		...
		while(1){
			...
			ODM_SetBBReg(pDM_Odm, 0x82c, BIT(31), 0x1); // [31] = 1 --> Page C1
			if (pDM_Odm->SupportInterface == 1 && pDM_Odm->RFEType == 1){
				ODM_Write4Byte(pDM_Odm, 0xc8c, 0x28161900);
			}
			else{
